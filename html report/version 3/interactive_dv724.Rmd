---
title: "Proteomic consistency metrics -- Development Version 3(Interactive)"
...
```{r, include=FALSE}
# generate a function to try to put the plots side by side and add the legend at the bottom 
...
### Per sample, across fraction (boxplot), same scale
...
This graph represents scatter plot of the number of MS2 spectra versus fractions in separate scales. Each analytical sample is represented by a different color. 
...
This graph represents scatter plot of the number of MS2 spectra versus fractions in the same scale. Each analytical sample is represented by a different color. 
...
This graph represents box plot of the number of MS2 spectra versus fractions in separate scales. Each analytical sample is represented by a different color. 
...
This graph represents boxplot of the number of MS2 spectra versus fractions in the same scale. Each analytical sample is represented by a different color. 
